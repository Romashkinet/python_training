...
file_name = create_file('news_feed_task8.txt')
...
class SelectInputMode(SelectType,FileRecords,JsonRecords):
    def __init__(self):
        input_mode = ''
        while input_mode not in ['manual', 'txt', 'json']:
            input_mode = input(f"Please select how you'd like to enter the data manual, txt or json: ")
